...
<!-- Google tag (gtag.js) -->
    ...
    <a href="https://www.linkedin.com/in/juan-gardea-26b39427a/" target="_blank" class="blueShadow relative overflow-hidden px-5 py-2 group rounded-full bg-white text-slate-950">
